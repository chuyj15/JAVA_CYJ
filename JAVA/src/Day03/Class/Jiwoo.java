...
//		pikachu.level = 1;
		...
		System.out.println("에너지: "+ pikachu.energy);   // 에너지: 0
		System.out.println("타입: "+pikachu.type); //  타입: null
		System.out.println("레벨: "+pikachu.level);
		System.out.println("공격 A: "+ pikachu.aAttack()); // 공격 A: 십만볼트
		System.out.println("공격 B: "+ pikachu.bAttack()); // 공격 B: 전광석화
		System.out.println();
