...
public class SimpleDateFormatEx {
	public static void main(String[] args) throws ParseException {
		...
		System.out.println(sdf.format(now));		//23. 8. 9. 오전 11:48 -- 기본적으로는 이렇게 포맷이 형성되어있음. 
		
		String day = "2023/08/09";
		Date date = new SimpleDateFormat("yyyy/MM/dd").parse(day);		//지정한 날짜형식으로 문자열 날짜를 분석하여 Date 객체 생성
		sdf = new SimpleDateFormat("yyyy/M/d");
		System.out.println(sdf.format(date));		//2023/8/9
