...
public class DateTimeCompare {
	public static void main(String[] args) {
		...
		//A.isEqual(B): A랑 B랑 같으면, true 아니면 false
		...
		//  남은 시간을 반환하는 메소드
		long remainYear = todayDateTime.until(endDateTime, ChronoUnit.YEARS);	//ChronoUnit 에 각각 단위를 가지고 있음. 단위를 두번째 인자로 넣어줌. 
		...
		//질문
		//ChronoUnit.YEARS.between() ==>   ChronoUnit: 열거형 상수들의 집합(클래스는 아님)
		//YEARS: 그 안에 있는 상수 중 하나인데, 가서 보면 Duration이라는 클래스형임. 
		//따라서 ChronoUnit.YEARS 는 Duration이라는 클래스형의 객체이고, 거기에 between이라는 메소드를 쓴 거임. 
