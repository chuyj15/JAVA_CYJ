...
public class DownCasting {
	public static void main(String[] args) {
		...
		System.out.println(person);    // 메소드임!! //Student [grade=1, major=신재생에너지과]
		System.out.println(person.work()); //공부를 합니다
		
		System.out.println("grade : "+student.grade);    //grade : 1
		System.out.println("major : "+student.major);	//major : 신재생에너지과
